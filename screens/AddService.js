    ...
    <View style={styles.base}>
      ...
      <PagerView style={styles.pagerView} initialPage={2} ref={pagerView}>
        <View key="1" style={styles.input_view_style}>
          ...
          <InputCard hint={strings.input_phone_number} maxCharacters={10}>
            {" "}
          </InputCard>
          <InputCard hint={strings.input_facebook} maxCharacters={30}>
            {" "}
          </InputCard>
          <InputCard hint={strings.input_website} maxCharacters={30}>
            {" "}
          </InputCard>
        </View>
